function e = blackRock2event(nevData, ns1File)
...
%
% Uso: e = blackRock2event(nevData, nsfile, unit, saveName)
%
...
%% Cargar el archivo con la estructura NEV
disp('Cargando archivos...')
NEV = openNEV (nevData, 'nosave');
NS1 = openNSx(ns1File);
goodRob = 1;
%% Informacion de la corrida
disp('Obteniendo información de la corrida...')
...
disp('Separando las señales digitales por fuentes...')
...
% disp ('Obteniendo los datos de los eventos neuronales')
...
disp('Calculando el inicio y el final de cada ensayo...')
...
disp('Obteniendo estampas de tiempo de cada ensayo...')
...
% Guardar toda la informacion del ensayo en la estructura trial
    ...
    trial(i) = struct('anguloInicio', ai,...
                    'anguloRotacion', ar,...
                    'velocidad', vel,...
                    'tiempo', time,...
                    'tiempoMedido', tiempoMedido,...
                    'categoria', categ,...
                    'anguloTarg', targ,...
                    'respuesta', resp,...
                    'correcto', evalResp,...
                    'digitalInfo', ensayo,...
                    'timeStamp', tstamp,...
                    'waitCueIni', waitCueIni,...
                    'manosFijasIni', manosFijasIni,...
                    'cmdIni', cmdIniRot(1),...
                    'waitCueFin', waitCueFin,...
                    ...
                    'touchFin',touchFin,...
                    'waitRespIni', waitRespIni,...
                    'targOn', targOn,...
                    'waitRespFin', waitRespFin,...
                    'targOff',targOff,...
 ...
 disp('Creando estructura...')
    e = struct('Fecha', fecha,...
            'FechaRaw', fechaR,...
            'ArchivoNEV', archivoNEV,...
            'ResTemp', resTemp,...
            'DatosCrudos', fromBlackRock,...
